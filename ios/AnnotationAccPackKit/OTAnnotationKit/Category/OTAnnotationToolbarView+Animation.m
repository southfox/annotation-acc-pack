    ...
    if (!self.colorPickerView.superview) {
        ...
        [UIView animateWithDuration:1.0 animations:^(){
            ...
            if (self.toolbarViewOrientation == OTAnnotationToolbarViewOrientationPortraitlBottom) {
                ...
                newY += HeightOfColorPicker;
                self.separatorView.frame = CGRectMake(selfFrame.origin.x, newY, CGRectGetWidth(self.bounds), 1);
            }
                ...
                newX += WidthOfColorPicker;
                self.separatorView.frame = CGRectMake(newX, selfFrame.origin.y, 1, CGRectGetHeight(self.bounds));
            }
